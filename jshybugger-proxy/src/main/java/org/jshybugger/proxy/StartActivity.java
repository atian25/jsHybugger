	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		clearCache.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	...
            	int numFiles = getApplicationContext().getContentResolver().delete(Uri.parse(DebugContentProvider.getProviderProtocol(getApplicationContext())), null, null);
        		LogActivity.addMessage(numFiles + " cache files deleted");
            }
        });
